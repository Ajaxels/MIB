function [imgOut, bbShiftXY] = mib_crossShiftStacks(I1, I2, shiftX, shiftY, options)
% [imgOut, bbShiftXY] = mib_crossShiftStacks(I1, I2, shiftX, shiftY)
...
% Copyright (C) 14.09.2016 Ilya Belevich, University of Helsinki (ilya.belevich @ helsinki.fi)
%
