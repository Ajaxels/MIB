...
%       textTable: -> a bitmap two color image with a table of letters (@em DejaVuSansMono.png)
...
if nargin < 3;     error('ib_addText2Img: wrong number of parameters');   end;
...
if isstruct(options)
    ...
    error('ib_addText2Img: parameter _options_ should be a structure!');    
end
...
switch options.fontSize
    ...
    otherwise
        error('ib_addText2Img: options.fontSize should be between 1 and 7');
end
