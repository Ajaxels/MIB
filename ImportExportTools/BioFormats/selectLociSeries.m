...
set(handles.imagePreview,'dataAspectRatio',[1 1 1]);
set(handles.imagePreview, 'xtick', []);
set(handles.imagePreview, 'ytick', []);
...
set(handles.selectedSeriesText,'String', num2str(unique(eventdata.Indices(:,1)')));
...
sliceNumber = round(get(handles.sliceNumberSlider, 'value'));
...
value = str2double(get(handles.sliceNumberEdit, 'String'));
if value > handles.output4(end,4)
    value = handles.output4(end,4);
    set(handles.sliceNumberEdit, 'String', num2str(value));
end
set(handles.sliceNumberSlider, 'value', value);
updateImagePreview(handles);
end
