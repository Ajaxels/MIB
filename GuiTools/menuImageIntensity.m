...
% function menuImageIntensity(hObject, eventdata, handles, parameter)
% a callback to Menu->Image->Intensity Profile
% get intensity values.
%
% It may be more beneficial to use Measure Tool in the
% Menu->Measure->Measure length section
%
% Parameters:
...
% Copyright (C) 22.04.2015, Ilya Belevich, University of Helsinki (ilya.belevich @ helsinki.fi)
