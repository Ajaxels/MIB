...
%| 
% @b Examples:
% @code imageData.moveView(50, 75);     // center the view at the pixel 50, 75 @endcode
% @code moveView(obj, 75);// Call within the class; center the view at the pixel with index 75 @endcode
