...
% <tr>
% <td style="border: 0px">
%   <img src = "images\19_statistics_dlg.jpg">
% </td>
% <td style="border: 0px">
% <ul>
% <li><b>1. The Slices panel</b> - using radio buttons of this panel it is possible to get statistical analysis for the currently selected slice 
% (<em>Shown slice</em>) or for the whole volume (<em>Whole volume</em>)</li>
% <li><b>2. The Detect Objects panel</b> - allows selection of type of objects to detect: |2D| or |3D|</li>
...
% <img src="images\19_statistics_dlg_defProps.jpg"></li>
...
%   <img src="images/19_statistics_dlg_crop.jpg"><br>
...
%   <li><b>.img_info</b> - meta data for the cropped image [1:height, 1:width, 1:colors, 1:stacks]</li>
%   <li><b>.Model</b> - a structure with the Model, including <em>.model, .materials, .colors</em> fields</li>
...
%   <em>Filename_IndexOfTheObject.img_info</em>.<br>
%   Or for the Model:
