...
% |im_browser|. The dataset can be imported as |Image|, |Model|, |Mask|, or
...
% layers should match the size of the opened in |im_browser| |Image| layer.
...
% # In |im_browser| select |Fiji Connect->Image Type->mask| and press the |Import| button
% # Now |im_browser| should have a new |Mask| layer imported from Fiji
%
%
% *Back to* <im_browser_product_page.html *Index*> |*-->*| <im_browser_user_guide.html *User Guide*> |*-->*| <ug_gui_panels.html *Panels*>