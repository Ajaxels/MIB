...
%% General info
% 
% <<images\07_panel_segm_tools.jpg>> 
%
% This panel consists of two parts. The left hand side of the panel has two combo boxes (|Selection type| and |Materials|) that are
% always seen. The view of the right hand side of the panel may be different depending on the |Selection type|.
%
% The segmentation tools can be selected using the |Selection type| combo box. 
%
% *_Note!_* Combination of |Ctrl + the mouse scroll wheel| allows modificaton of brush size and other segmentation tools.
%
% The |Materials| combo box defines type of the visualization for models. The models may be shown either as a filled or as outlined structure. 
% The transparency of the |Model| layer can be adjusted via the |Transparency| slider in the
% <ug_panel_view_settings.html View Settings panel>.
%
% 
%% 1. The 3D ball
%
...
% <tr>
% <td style="border: 0px">
%   <img src = "images\07_panel_segm_tools_annotations2.jpg">
% </td>
% <td style="border: 0px">
...
% <tr>
% <td style="border: 0px">
%   <img src = "images\07_panel_segm_tools_annotations.jpg">
% </td>
% <td style="border: 0px">
% <ul>
...
% <tr>
% <td style="border: 0px">
%   <img src = "images\07_panel_segm_tools_brush.jpg">
% </td>
% <td style="border: 0px">
...
%%
% 
% <<images\07_panel_segm_tools_brush_supervoxels.jpg>>
% 
...
% <tr>
% <td style="border: 0px">
%   <img src = "images\07_panel_segm_tools_bw_thresholding.jpg">
%   <img src = "images\07_panel_segm_tools_bw_thresholding_2.jpg">
% </td>
% <td style="border: 0px">
% Makes black and white thresholding of the current image slice or the
% whole dataset (depending on status of the <b>all</b> checkbox). 
% <br><br>
...
% <tr>
% <td style="border: 0px">
%   <img src = "images\07_panel_segm_tools_lasso.jpg">
% </td>
% <td style="border: 0px">
...
% </ul>
% When the <em>Ctrl</em> key is pressed during step 1, the selected area is subtracted from the existing selection.
% </td>
% </tr>
% </table>
% </html>
...
% <tr>
% <td style="border: 0px">
%   <img src = "images\07_panel_segm_tools_magic_wand.jpg">
% </td>
% <td style="border: 0px">
% <ul>
...
% <tr>
% <td style="border: 0px">
%   <img src = "images\07_panel_segm_tools_membrclicktracker.jpg">
% </td>
% <td style="border: 0px">
% <b>How to use:</b>
% <ul>
...
% <tr>
% <td style="border: 0px">
%   <img src = "images\07_panel_segm_tools_maskmodel.jpg">
% </td>
% <td style="border: 0px">
...
% <tr>
% <td style="border: 0px">
%   <img src = "images\07_panel_segm_tools_smartwatershed.jpg">
% </td>
% <td style="border: 0px">
% This is a simplified version of the watershed image segmentation. Please
% see details in the <a href="ug_gui_menu_tools_watershed.html">Menu->Tools->Watershed segmentation</a> section.
% <br><br>
% In brief: a model with 2 materials is needed. One material labels
% the background while another labels the object of interest. The labels
% can be drawn using the brush tool which is activated during the Smart
% Watershed. Use the <em>Ctrl+mouse wheel</em> to change size of the brush.
% <br><br>
% <ul>
% <li>The material that labels the background should be selected in the
% <b>Background</b> combobox</li>
% <li>The material that labels the object should be selected in the
% <b>Object</b> combobox</li>
% <li>Type of images should be selected in the lowest combobox. Select
% the <em>Black-on-white</em> option for electron microscopy data or
% <em>White-on-black</em> for light microscopy data</li>
% </ul>
% </td>
% </tr>
% </table>
% <b>How to use:</b>
% <ul>
% <li><b>To segment currently shown slice (2D)</b> just press the <b>Segment</b> button</li>
% <li><b>To segment all slices (2D)</b> hold the <em>Shift</em> key and press the <b>Segment</b> button</li>
% <li><b>To the whole dataset in 3D</b> check the <b>3D</b> checkbox in the <em>Selection panel</em> and press the <b>Segment</b> button</li>
% </ul>
% <b>Note 1:</b> for multi-colored images the color channel should be
% selecrted in the <b>Color channel</b> combobox of the <em>Selection
% panel</em>.
% <br><br>
% <b>Note 2:</b> this tool is compatible with the <a href="ug_panel_roi.html">ROI mode</a> and the <a href="ug_gui_toolbar.html#33"> block mode</a>.
% </html>
%
%
%% 10. The Spot tool 
