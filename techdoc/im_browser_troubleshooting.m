...
%% |im_browser| does not start
%%
% 
% * Check |im_browser| directories in Matlab path: |File->Set path...|.
% If they are missing, add them with |->Add with Subfolders-> Save|.
% * Delete old configuration file. For Windows: _c:\tmp\im_browser.mat_, or
% _C:\Users\User-name\AppData\Local\Temp\im_browser.mat_; for Linux in the
% script directory.
% 
%% Out of memory
% 
...
% * Use Models with 63 maximal materials, |Menu->File->Preferences->Models->Maximal
