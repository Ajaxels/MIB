...
% 
%% OMERO Import
% Establishes connection and loads images from OMERO server. Requires <http://www.openmicroscopy.org/site OMERO server> files to
...
% Export images to the main Matlab workspace. In addition to the image
...
%
%% Make movie
% Saves dataset as a movie file. All objects that are shown in the image view window will be captured. Note! If the image width is too small the scale bar is not rendered.
% <ug_gui_menu_file_makevideo.html See more here>. 
% 
% <<images\menuFileMakeVideo.jpg>>
% 
%% Make snapshot
% Makes snapshot of the current slice. All objects that are shown in the image view window will be captured.  <ug_gui_menu_file_makesnapshot.html See more here>.
%%
% 
...
%%
% 
% <<images/menuFileRenderFiji1.jpg>>
% 
%%
% 
