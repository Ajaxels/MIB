...
% 
%% Target
% Define the destination for the rendered snapshot. The snapshot may be saved to a file when the |File| option is selected, or copied
% to the system clipboard, when the |Clipboard| options is selected.
%
%% Crop
%
