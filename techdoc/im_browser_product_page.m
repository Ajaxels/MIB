...
%   <td><em>a handy tool for image management!</em><br><br>
...
% </html>
% 
% API class reference can be accessed from the |im_browser->Menu->Help->Class reference|
%
...
% 
% <html>
% Developed during 2010-2016 by<br>
% Core developer:<br>
